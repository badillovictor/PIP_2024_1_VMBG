...
qtCreatorFile = "P_05_HorizontalSlider.ui"  # Nombre del archivo aquí.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.horizontalSlider.valueChanged.connect(self.setData)

    # Área de los Slots
    def setData(self):
        try:
            print(self.horizontalSlider.value())
            dataKey = self.horizontalSlider.value()
            print(dataKey)
